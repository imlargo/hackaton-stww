...
## Vistas y necesidades

### 1. Dashboard Administrativo (colegio)
- Registrar colegio (ubicación y otra información social útil).
- Inscribir niños.
...
- Esa caracterización se puede cruzar (con información/contenido disponible).
- A partir de eso, se enseña a cuidar a los animales.

### 3. Home del estudiante
- Onboarding con info del colegio (preregistrado).
- Ver su progreso.
- Contenido de aprendizaje (lecciones).
- Juegos y actividades (incluye construir minigranja).
- Scoreboard del colegio.

### 4. Vista de Unergy
- Visualizar escuelas.
- Métricas de datos.
- Agregar contenido y lecciones.
- Scoreboard.
- Prospectos de colegios.

---

## Necesidad transversal (Administrativo + Estudiante)
- Solicitar visita y ver progreso/estado de esa solicitud.
- Ver disponibilidad y cronograma.
- Ver a dónde irá Unergy.
- Idea: ganar puntos para ganar/desbloquear la visita a la minigranja y a la comunidad.

---

## Nota suelta
- "Dendrobates truncatus, rana" — queda sin contexto definido (posible ejemplo de contenido/especie a incluir en la plataforma). Pendiente de aclarar.